    ...
    <nav className="sticky top-0 z-50 border-b border-[#243652] bg-[#081120]/90 backdrop-blur-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-5">
        ...
        <div className="hidden items-center gap-10 text-sm font-medium lg:flex">
          ...
          <a
            href="#features"
            className="text-[#B8C2D3] transition hover:text-[#C7F464]"
          >
            Features
          </a>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="hidden lg:block rounded-xl border border-[#D4AF37] px-5 py-2 text-[#D4AF37] transition hover:bg-[#D4AF37] hover:text-[#081120]"
          >
            Login
          </a>

          <button
            className="rounded-xl bg-[#C7F464] px-6 py-3 font-semibold text-[#081120] shadow-lg transition hover:scale-105 hover:bg-[#D8FF6A]"
          >
            <a
